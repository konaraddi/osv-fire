/*TODO
Learn in depth about how this stuff works
(e.g. how the library compiles in arduino? what is the .cpp files that some libraries have?)
Answer all questions in comments across coordinates.h and this file.
*/

#include "coordinates.h" //custom library
#include "marker.h"
#include "rf_comm.h"
#include <SoftwareSerial.h>
#include <Arduino.h>

//HOW DOES THE LIBRARYIES GET INCLUDED IF THEY'RE IN A SEPARATE FOLDER?
//for the Adafruit MotorShield
